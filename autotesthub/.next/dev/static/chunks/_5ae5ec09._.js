...
function SignupPage() {
    ...
    if ($[0] !== "46004f4e8c27e6acb5eb86891bbfd8d10d22df5ea9cca1ad06fc0664510dd9f8") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "46004f4e8c27e6acb5eb86891bbfd8d10d22df5ea9cca1ad06fc0664510dd9f8";
    }
    ...
    if ($[1] !== email || $[2] !== password || $[3] !== router) {
        t0 = ({
            "SignupPage[handleSignup]": async (e)=>{
                e.preventDefault();
                setLoading(true);
                setError(null);
                const { error: error_0 } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email,
                    password
                });
                if (error_0) {
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "SignupPage[<input>.onChange]": (e_0)=>setEmail(e_0.target.value)
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "SignupPage[<input>.onChange]": (e_1)=>setPassword(e_1.target.value)
        })["SignupPage[<input>.onChange]"];
        $[11] = t5;
    } else {
        t5 = $[11];
    ...
    const t7 = loading ? "Signing up..." : "Sign Up";
    let t8;
    if ($[14] !== loading || $[15] !== t7) {
    ...
    let t9;
    if ($[17] !== handleSignup || $[18] !== t2 || $[19] !== t4 || $[20] !== t6 || $[21] !== t8) {
...
//# sourceMappingURL=_5ae5ec09._.js.map